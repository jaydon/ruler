...
public class RulerView extends View{
    ...
    private static final int DEFAULT_LINE_MIDDLE_COUNT = 3;
    ...
    private void drawLine(Canvas canvas) {
        ...
        int top = 0;
        for(int i = 1; i <= DEFAULT_LINE_COUNT * DEFAULT_LINE_MIDDLE_COUNT; i++) {
            //绘制最长线
            if(i % 10 == 0 || i == 1) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mOutRect = new Rect(mRulerLeftRightMargin, mRulerTopBottomMargin, mTotalWidth - mRulerLeftRightMargin, mTotalHeight - mRulerTopBottomMargin);
